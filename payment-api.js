const PAYMENT_API = {
    // ============================================================
    // LZPEDIA API INTEGRATION - V2 (FIXED ERROR HANDLING)
    // ============================================================
    backendUrl: window.location.origin + '/lzproxy.php',

    // ============================================================
    // 1. BUAT INVOICE (CREATE)
    // Endpoint: GET https://app.lzpedia.my.id/api/invoice
    // ============================================================
    async createInvoice(amount) {
        try {
            const url = `${this.backendUrl}?action=create&amount=${amount}`;
            console.log('📤 Create Invoice URL:', url);
            ...
            try {
                ...
                console.error('❌ Raw text yang gagal di-parse:', text);
                return {
                    success: false,
